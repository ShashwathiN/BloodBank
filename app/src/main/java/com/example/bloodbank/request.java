...
public class request extends AppCompatActivity {
    ...
    TextView name,blood,amount,phone;
    String m;
    ImageView i;
    TableLayout stk;
    View tbr;
    ...
    int chec=9,nameid=10,amountid=11,bloodid=12,phoneid=13;
    boolean bool;
    String str="";
    ...
    public void onCreate(Bundle savedInstanceState) {
                ...
                database.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                            ...
                            if(m.equals(s)||donor.name.contains(s)||donor.blood.contains(s)||donor.amount.equals(s)) {
                        ...
                        if(flag==1){
                            Toast.makeText(request.this, "Results available", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(request.this, "No such data", Toast.LENGTH_SHORT).show();
                            adddata();
                        }
                    }
        ...
        /*delete.setOnClickListener(new View.OnClickListener() {
            ...
            int checked=0;
                ...
                if(checked==0){
                    Toast.makeText(request.this, "Please select something", Toast.LENGTH_SHORT).show();
                }
                else{
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(count==0){
                    Toast.makeText(request.this, "please click something", Toast.LENGTH_SHORT).show();
                }
                else if(count>=2){
                    Toast.makeText(request.this, "Please edit one record at a time", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Intent intent= new Intent(request.this,update_request.class);
        ...
        newentry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(request.this, request_add.class);
                startActivity(intent);
...
*/
    ...
    public void addTable(String m,String name,String phone, String blood, String amount) {
        ...
        tbrow0.setId(tabrow);
        CheckBox tv0 = new CheckBox(this);
        tv0.setText(m);
